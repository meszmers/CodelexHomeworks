...
display_board($b);
    ...
    for ($y = 0; $y < 9; $y++ ) {
                ...
                do {
                    ...
                    $playerInput = [array("row" => $inputOne, "column" => $inputTwo)];


                    $x = "end";

                    if ($playerInput[0] == $data[0]) {
                        if ($b[0] == "0" || $b[0] == "X") {
                            $x = "repeat";
                            echo "Wrong Input\n";
                        } else $b[0] = $turn;
                    } elseif ($playerInput[0] == $data[1]) {
                        if ($b[1] == "0" || $b[1] == "X") {
                            echo "Wrong Input\n";
                            $x = "repeat";
                        } else $b[1] = $turn;
                    } elseif ($playerInput[0] == $data[2]) {
                        if ($b[2] == "0" || $b[2] == "X") {
                            echo "Wrong Input\n";
                            $x = "repeat";
                        } else $b[2] = $turn;
                    } elseif ($playerInput[0] == $data[3]) {
                        if ($b[3] == "0" || $b[3] == "X") {
                            echo "Wrong Input\n";
                            $x = "repeat";
                        } else $b[3] = $turn;
                    } elseif ($playerInput[0] == $data[4]) {
                        if ($b[4] == "0" || $b[4] == "X") {
                            echo "Wrong Input\n";
                            $x = "repeat";
                        } else $b[4] = $turn;
                    } elseif ($playerInput[0] == $data[5]) {
                        if ($b[5] == "0" || $b[5] == "X") {
                            echo "Wrong Input\n";
                            $x = "repeat";
                        } else $b[5] = $turn;
                    } elseif ($playerInput[0] == $data[6]) {
                        if ($b[6] == "0" || $b[6] == "X") {
                            echo "Wrong Input\n";
                            $x = "repeat";
                        } else $b[6] = $turn;
                    } elseif ($playerInput[0] == $data[7]) {
                        if ($b[7] == "0" || $b[7] == "X") {
                            echo "Wrong Input\n";
                            $x = "repeat";
                        } else $b[7] = $turn;
                    } elseif ($playerInput[0] == $data[8]) {
                        if ($b[8] == "0" || $b[8] == "X") {
                            echo "Wrong Input\n";
                            $x = "repeat";
                        } else $b[8] = $turn;
